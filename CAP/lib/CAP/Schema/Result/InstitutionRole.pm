use utf8;
package CAP::Schema::Result::InstitutionRole;
...
=head1 TABLE: C<institution_role>

=cut

__PACKAGE__->table("institution_role");
...
__PACKAGE__->add_columns(
  ...
  { data_type => "integer", is_foreign_key => 1, is_nullable => 0 },
  "role",
  { data_type => "enum", extra => { list => ["stats"] }, is_nullable => 0 },
);
...
__PACKAGE__->set_primary_key("user_id", "institution_id", "role");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:y6x+uXKngaFnwN0yetjS6g
